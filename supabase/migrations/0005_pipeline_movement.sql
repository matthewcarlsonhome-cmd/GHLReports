-- Pipeline movement, last 30 days: how many deals were created, changed
-- stage, or closed. Zero movement with a real book of open deals fires the
-- PIPELINE_FROZEN flag ("client stopped working the pipeline — reach out").
alter table public.snapshots add column opps_moved_30d int;

-- v_portfolio unchanged except opps_moved_30d appended at the end
